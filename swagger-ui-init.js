...
window.onload = function() {
  ...
  "swaggerDoc": {
      ...
      "schemas": {
        ...
        "Consultation": {
          ...
          "properties": {
            "_id": {
              "type": "string",
              "example": "69dac82734efdf1db134f26b"
            },
            "user": {
              "type": "string",
              "example": "69d0d1776a8f0d5465660740"
            },
            "date": {
              "type": "string",
              "format": "date-time",
              "example": "2026-04-12T18:30:00.000Z"
            },
            "time": {
              "type": "string",
              "example": "10:00 AM"
    ...
    "paths": {
      ...
      "/auth/resend-otp": {
        "post": {
          "summary": "Resend OTP for unverified users",
          "description": "Generates and sends a new OTP to the user. Has a 60-second cooldown between requests.\n\n**Mock OTP values (same as signup):**\n- Student: last 4 digits of mobile number\n- Recruiter: `1234`\n",
          "tags": [
            "Auth"
          ],
          "requestBody": {
      ...
      "/consultations/book": {
        "post": {
          "summary": "Book a new consultation appointment",
          "description": "Creates or updates a user as a lead (consultation role) and books an appointment. Returns a token for immediate access to appointments.",
          "tags": [
            "Consultation"
          ],
          "requestBody": {
                ...
                "application/json": {
                  "schema": {
                    ...
                    "properties": {
                      ...
                      "data": {
                        "$ref": "#/components/schemas/ConsultationBookResponse"
                      }
                    }
                  }
                }
      ...
      "/consultations/my-appointments": {
        "get": {
          "summary": "Get all consultation appointments for the logged-in user",
          "tags": [
            "Consultation"
          ],
          "security": [
          ...
          "responses": {
            "200": {
              "description": "List of appointments categorized into active and past",
              "content": {
                "application/json": {
                  "schema": {
                    "type": "object",
      ...
      "/admin/time-slots": {
        "post": {
          "summary": "Create new time slots for a date",
          "tags": [
            "Admin - Time Slot"
          ],
          "security": [
        ...
        "get": {
          "summary": "Get all time slots (admin)",
          "tags": [
            "Admin - Time Slot"
          ],
          "security": [
      ...
      "/admin/time-slots/{id}": {
        "get": {
          "summary": "Get time slot details by ID",
          "tags": [
            "Admin - Time Slot"
          ],
          "security": [
      ...
      "/time-slots": {
        "get": {
          "summary": "Get all active time slots (public)",
          "tags": [
            "Public - Time Slot"
          ],
          "responses": {
            "200": {
              "description": "List of available dates and time slots"
            }
          }
        }
      },
